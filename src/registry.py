...
class ComponentRegistry:
    ...
    def register_logic_config_classes(self, name, logic_cls=None, config_cls=None, category: str = "default"):
        """
        ...
        if logic_cls:
            ...
            self.register_logic_cls(name, self._logic_base_cls)
        if config_cls:
            assert issubclass(config_cls, self._config_base_cls)
            self.register_config_cls(name, config_cls)
        else:
            self.register_config_cls(name, self._config_base_cls)
